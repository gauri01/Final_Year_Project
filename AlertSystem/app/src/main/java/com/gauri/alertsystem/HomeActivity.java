...
public class HomeActivity extends AppCompatActivity
    ...
    Button btnLogin,btnRegister,btnTask;
    DBManager DBManager;
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_list) {
            startActivity(new Intent(HomeActivity.this,ShowListActivity.class));
    ...
    private void initialise() {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            final EditText editTextUserName = (EditText) findViewById(R.id.etName);
            ...
            public void onClick(View view) {
                ...
                String storedPassword = DBManager
                ...
                if (password.equals(storedPassword)) {
                    ...
                    Intent userActivity = new Intent(HomeActivity.this,
